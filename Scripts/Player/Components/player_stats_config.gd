...
@export_range(1, 10, 1) var starting_motion := 1
...
@export_range(1, 100000, 1) var base_carry_weight_grams := 300
@export_range(0, 10000, 1) var carry_weight_per_strength := 50
@export_range(1, 10, 1) var max_hustle := 10
@export_range(1, 10, 1) var max_motion := 10
@export_range(0.0, 1.0, 0.01) var loyalty_bonus_per_motion := 0.10
@export_range(0.0, 3.0, 0.01) var base_customer_price_markup := 0.70
@export_range(0.0, 1.0, 0.01) var sale_bonus_per_hustle := 0.15
