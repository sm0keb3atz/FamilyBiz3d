...
func _run() -> void:
	...
	first.condition_component.consume_fuel(3.5)
	first.condition_component.apply_damage(22.0)
	first.condition_component.set_primary_color(Color(0.2, 0.3, 0.7))
	first.condition_component.set_secondary_color(Color(0.8, 0.2, 0.1))
	first.condition_component.set_window_tint(0.75)
	first.condition_component.set_performance_tier(2)
	...
	assert(is_equal_approx(retrieved.condition_component.fuel_gallons, 14.5))
	assert(is_equal_approx(retrieved.condition_component.damage, 22.0))
	assert(retrieved.condition_component.primary_color.is_equal_approx(Color(0.2, 0.3, 0.7)))
	assert(retrieved.condition_component.secondary_color.is_equal_approx(Color(0.8, 0.2, 0.1)))
	assert(is_equal_approx(retrieved.condition_component.window_tint, 0.75))
	assert(retrieved.condition_component.performance_tier == 2)
